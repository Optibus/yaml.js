...
Inline = (function() {
  ...
  Inline.pipeLines = function(value, prefix) {
    var ch, i, str;
    str = '|-\n' + prefix;
    i = 0;
...
Utils = (function() {
  ...
  Utils.testForPipe = function(input) {
    var err, hasNewlines;
    hasNewlines = null;
    try {
    ...
    return hasNewlines && (Escaper.requiresDoubleQuoting(input) || Escaper.requiresSingleQuoting(input));
  };
